...
(c) Alex Samorukov, samm@os2.kiev.ua, Modified Warp v0.2025.08.13.08.12.stable_02
*/

error_reporting(E_ALL);

DEFINE("SQSTAT_VERSION","1.23");
...
// Set timezone
if (defined("SQSTAT_TIMEZONE")) {
	date_default_timezone_set(SQSTAT_TIMEZONE);
} else {
	...
	if ($timezone) {
		...
		if ($link && preg_match("|\/zoneinfo\/(.*)$|", $link, $matches)) {
			$timezone = $matches[1];
		} else {
